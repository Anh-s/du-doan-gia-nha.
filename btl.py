...
df = df.iloc[:, 1:]
df_norm = (df - df.mean()) / df.std() #Dữ liệu được chuẩn hóa bằng cách trừ mỗi giá trị trong cột với giá trị trung bình rồi chia cho độ lệch chuẩn của toàn bộ cột
df_norm.head()
